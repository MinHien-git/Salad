...
namespace Utility.SLayout
{
    ...
    public abstract class SLayoutGroup : UIBehaviour, ILayoutElement, ILayoutGroup
    {
        ...
        private Dictionary<RectTransform, Tween> RectPositionXTweens =
            new Dictionary<RectTransform, Tween>();
        private Dictionary<RectTransform, Tween> RectPositionYTweens =
            new Dictionary<RectTransform, Tween>();
        ...
        {
            float requiredSpace =
                requiredSpaceWithoutPadding + (axis == 0 ? padding.horizontal : padding.vertical);
